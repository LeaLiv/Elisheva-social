...
const Process: React.FC = () => {
  const steps = [
    {
      title: "ראש שקט",
      desc: "את עובדת, אני דואגת לתיעוד. בלי לעצור את העבודה בשביל 'סלפי'. אני הופכת לצל ביום העבודה שלך.",
      color: "bg-stone-100",
      num: "01"
    },
    {
      title: "חיבור ואמון",
      desc: "לקוחות קונים מאנשים. הם רואים אותך, את המקצועיות שלך, ומרגישים בטוחים יותר לשכור את שירותייך.",
      color: "bg-white",
      num: "02"
    },
    {
      title: "הרווח שלך",
      desc: "שקט תעשייתי ונוכחות עקבית. לא רק שיש לך תוכן – יש מי שמנהלת אותו. האינסטגרם עובד בשבילך 24/7.",
      color: "bg-stone-100",
      num: "03"
    }
  ];
  ...
  const features = [
    { 
      ...
      desc: "פגישת אפיון מדויקת להבנת הייחוד שלך והסיפור שאנחנו הולכות לספר."
    },
    { 
      title: "יום צילום ותיעוד בשטח",
      desc: "אני מגיעה, מצלמת, מביימת ודואגת שהכל יראה מיליון דולר בזמן שאת עובדת."
    },
    { 
    ...
    { 
      ...
      desc: "כאן אני לוקחת את המושכות. העלאת פוסטים וסטוריז, קופירייטינג שמניע לפעולה, ושמירה על דופק חי בעמוד. את מקבלת ראש שקט באמת."
    },
  ];
        ...
        <div className="bg-white rounded-3xl p-8 md:p-16 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row relative z-10 gap-12">
            <div className="w-full md:w-3/5 mb-10 md:mb-0">
               <h3 className="text-3xl md:text-4xl font-bold mb-8">מעטפת סושיאל מלאה למעצבות</h3>
               <p className="text-xl text-stone-600 mb-10 max-w-lg">
                 אנחנו לא רק מעלות תמונות. אנחנו בונות מותג. מיום הצילום ועד לניהול השוטף - אני הדאגה האחרונה שלך בלו"ז.
               </p>

  ...
  process: {
    ...
    tracks: [
      ...
      },
      {
        ...
        features: [
          "זיקוק מסר ובניית תוכן: אפיון המסר הייחודי שלך ותוכנית תוכן ממוקדת.",
          ...
          "ניהול עצמאי: את מקבלת את הכלים והחומרים, וכבר את יכולה לנהל את העמוד בעצמך."
        ],
...

      {
        ...
        features: [
          "אסטרטגיית מותג: הבידול שלך, השפה הוויזואלית והתוכנית השיווקית שמייצרים מותג מנצח.",

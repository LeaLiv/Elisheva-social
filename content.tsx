  ...
  process: {
    ...
    tracks: [
      ...
      },
      {
        ...
        features: ["מרימים אירוע עסקי? השקה? סדנה?", "תיעוד האווירה, סרטון תדמית, האנרגיות והרגעים הקטנים.", "התוצאה: מזכרת ויזואלית עוצמתית שמשווקת כחומר שיווקי מעולה לאירוע הבא."],
